<template>
  ...
  <main class="main-content mt-0">
    <div
      ...
      style="background-image: url('https://images.everydayhealth.com/images/emotional-health/meditation/a-complete-guide-to-meditation-722x406.jpg?w=1110'); background-position: top;"
    >
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            >Register below to start your wellness journey</p>
          </div>
        </div>
      </div>
    </div>
