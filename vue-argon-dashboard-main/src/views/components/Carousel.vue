      ...
      backgroundSize: 'cover'}"
        >
          <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
            ...
            <h5 class="text-white mb-1">Learn About Your Sleep</h5>
            <p></p>
          </div>
        </div>
        <div
      ...
      backgroundSize: 'cover'}"
        >
          <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
            ...
            <h5 class="text-white mb-1">The Fastest way to get good at meditation</h5>
            <p></p>
          </div>
        </div>
        <div
      ...
      backgroundSize: 'cover'}"
        >
          <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
            ...
            <h5 class="text-white mb-1">Share with your team your health tips!</h5>
            <p></p>
          </div>
        </div>
      </div>
